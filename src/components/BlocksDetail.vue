  ...
  <div class="transactions_detail_wrap">
    ...
    <div :class="transactionsDetailWrap">
      <div class="transactions_detail_information_wrap">
        <div class="transactions_detail_information_wrap_information">
        ...
        <div class="transactions_detail_information_wrap_last">
  ...
  export default {
    ...
    methods: {
      getBlockTxStatistics(){
        /*${this.$http_u}*/
        let url = `${this.$http_u}/api/txs/statistics?height=${this.$route.params.height}`;
      ...
      tabTxList(index,txTabName,currentPage,pageSize){
        ...
        if(txTabName === 'Transfers'){
          url = `${this.$http_u}/api/tx/trans/${currentPage}/${pageSize}?height=${this.$route.params.height}`
        }else if(txTabName === 'Stakes'){
          url = `${this.$http_u}/api/tx/stake/${currentPage}/${pageSize}?height=${this.$route.params.height}`

        }else if(txTabName === 'Declarations'){
          url = `${this.$http_u}/api/tx/declaration/${currentPage}/${pageSize}?height=${this.$route.params.height}`
        }else if(txTabName === 'Governance'){
          url = `${this.$http_u}/api/tx/gov/${currentPage}/${pageSize}?height=${this.$route.params.height}`
        }
        axios.get(url).then((data) => {
          if(data.status === 200){
            return data.data;
      ...
      getBlockInformation() {
        /*${this.$http_u}*/
        let url = `${this.$http_u}/api/block/${this.$route.params.height}`;
        axios.get(url).then((data) => {
          if (data.status === 200) {
            return data.data;
          }
      ...
      getMaxBlock() {
        /*${this.$http_u}*/
        let url = `${this.$http_u}/api/blocks/1/1`;
        axios.get(url).then((data) => {
          if (data.status === 200) {
            return data.data;
          }

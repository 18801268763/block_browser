<template>
  <div class="transactions_detail_wrap">
    ...
    <div class="transactions_detail_core">
      ...
      <div :class="transactionsDetailWrap" class="current_tenure" v-show="showProfile">
        <p class="transaction_information_content_title" style="">Current Tenure</p>
      ...
      <div :class="transactionsDetailWrap" class="address_table">
  ...
  export default {
    ...
    methods: {
      getAddressTxStatistics(){
        let url = `${this.$http_u}/api/txs/statistics?address=${this.$route.params.param}`;
      ...
      tabTxList(index,txTabName,currentPage,pageSize){
        ...
        if(txTabName === 'Transfers'){
          url = `${this.$http_u}/api/tx/trans/${currentPage}/${pageSize}?address=${this.$route.params.param}`
        }else if(txTabName === 'Stakes'){
          url = `${this.$http_u}/api/tx/stake/${currentPage}/${pageSize}?address=${this.$route.params.param}`

        }else if(txTabName === 'Declarations'){
          url = `${this.$http_u}/api/tx/declaration/${currentPage}/${pageSize}?address=${this.$route.params.param}`
        }else if(txTabName === 'Governance'){
          url = `${this.$http_u}/api/tx/gov/${currentPage}/${pageSize}?address=${this.$route.params.param}`
        }
        axios.get(url).then((data) => {
          if(data.status === 200){
            return data.data;
      ...
      getAddressInformation(address){
        ...
        let url = `${this.$http_u}/api/account/${this.$route.params.param}`;
        axios.get(url).then((data)=>{
          if(data.status === 200){
            return data.data;
          }
      ...
      getProfileInformation(){
        let url = `${this.$http_u}/api/stake/candidate/${this.$route.params.param}`;
        axios.get(url).then((data)=>{
          if(data.status === 200){
            return data.data;
          }
      ...
      getCurrentTenureInformation(){
        let url = `${this.$http_u}/api/stake/candidate/${this.$route.params.param}/status`;
        axios.get(url).then((data)=>{
          if(data.status === 200){
            return data.data;
          }
      ...
      getTransactionsList(){
        let url = `${this.$http_u}/api/txsByAddress/${this.$route.params.param}/1/30`;
        axios.get(url).then((data)=>{
          if(data.status === 200){
            return data.data;
          }
      ...
      getValidatorHistory(tabTime,index){
        ...
        let url;
        if(tabTime == "14days"){
          url = `${this.$http_u}/api/stake/candidate/${this.$route.params.param}/power/week`;
        }else if(tabTime == "30days"){
          url = `${this.$http_u}/api/stake/candidate/${this.$route.params.param}/power/month`;
        }else if(tabTime == "60days"){
          url = `${this.$http_u}/api/stake/candidate/${this.$route.params.param}/power/months`;
        }
        axios.get(url).then((data)=>{
          if(data.status === 200){
            return data.data;
      ...
      getValidatorUptimeHistory(tabTime,index){
        ...
        let url;
        if(tabTime == "24hours"){
          url = `${this.$http_u}/api/stake/candidate/${this.$route.params.param}/uptime/hour `;
        }else if(tabTime == "14days"){
          url = `${this.$http_u}/api/stake/candidate/${this.$route.params.param}/uptime/week `;
        }else if(tabTime == "30days"){
          url = `${this.$http_u}/api/stake/candidate/${this.$route.params.param}/uptime/month `;
        }
        axios.get(url).then((data)=>{

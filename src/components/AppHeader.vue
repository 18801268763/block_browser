  ...
  <div :class="appHeaderVar" v-show="showHeader" id="header">
    <header class="app_header_person_computer" v-show="devicesShow === 1">
      <div class="header_top">
        <div class="imageWrap" @click="featureButtonClick('/block/1/0')">
          <img src="../assets/oasislogo.png" alt="失去网络了..."/>
        </div>
        <!-- <div class="navSearch">
    ...
    <div class="useFeature" v-show="devicesShow === 1">
      <div class="navButton">
        ...
        <span class="nav_item common_item_style" :class="activeClassName === '/transaction'?'nav_item_active':''"
              @click="featureButtonClick('/transactions/2/transfer')"
        >Transactions</span>
